...
import server.nanohttpd.NanoHTTPD.HTTPSession;
...
public interface WebServerPlugin {
	...
	NanoHTTPD.Response serveFile(String uri, Map<String, String> headers, HTTPSession session, File file, String mimeType);
}
